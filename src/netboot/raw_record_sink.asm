...
; RRS_LINEAR via the B-DOS HWSAD hook (bdos_write_record, one sector) into the
; currently HRECORD-selected record — the caller selected it — then advance
; RRS_LINEAR and reset RRS_FILL to 0.
;
; Clobbers A, BC, DE, HL.
; ===========================================================================
rrs_flush_sector:
