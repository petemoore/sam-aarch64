...
; -----------------------------------------------------------------------
; run_symbol_table_self_tests — entry point dispatched from the off-axis
; page-12 cluster (test_offaxis_cluster.asm cluster_dispatch, first entry,
; before run_local_label_self_tests).
;
; Input:  none.
