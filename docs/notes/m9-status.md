...
which ungates the i4/i6/i5 UI strand via i76. The live gate on that strand is
now the **i76 spec approval** (spec gate; recommendations + 2 questions in
`docs/specs/editor-tui-prototype-design.md` §8).
