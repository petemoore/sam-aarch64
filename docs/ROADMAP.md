...
| M6 | Paged OUT + paged IN + compact `.tbn` format + built-in disassembler (real spectrum4 fixture round-tripping byte-identical via SAM) | `docs/specs/2026-05-27-m6-paged-out-design.md` + `docs/specs/2026-05-27-compact-tbn-and-disassembler-design.md` | `docs/notes/m6-status.md` | ⏳ in progress (PR 1 of N — paged OUT landed) |
