...
- `https://github.com/petemoore/sam-aarch64/blob/d874a69/docs/notes/m8-status.md`, `docs/ROADMAP.md`, `docs/notes/item-registry-open.md` `[A][B]` — i48 strands + status (this change).
- `docs/notes/question-registry-open.md` — residual open questions q5/q6/q7 (§8).
...
## 8. Open questions (→ `question-registry-open.md`)
