...
- `https://github.com/petemoore/sam-aarch64/blob/d874a69/docs/notes/m8-status.md`, `docs/ROADMAP.md`, `docs/notes/item-registry.md` `[A][B]` — i48 strands + status (this change).
