...
//     and disasm.bin as "d15" (page 15).  The encode_inst family (and its
//     page-11 enc_fix payload) lives in the enc-tests variant — see
//     boot_self_test_encode_test.go (i234).
...
// boot expects) and runs the test-variant assembler to completion.  The
// encode_inst fixture payload (page 11) is NOT here: the encode family boots
// in the enc-tests variant (runBootEncodeSelfTests, i234).
