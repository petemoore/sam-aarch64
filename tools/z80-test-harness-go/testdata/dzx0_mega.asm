; dzx0_mega.asm — pyz80 port of the ZX0 "Mega" decoder (673 bytes).
;
; Ported from reference/zx0/z80/dzx0_mega.asm (upstream commit
...
;
; The decoder is self-modifying (it patches its last-offset immediate
; at dzx0m_last_offset+1), so it must run from RAM.
;
...
;   pyz80 --obj=dzx0_mega.bin dzx0_mega.asm
